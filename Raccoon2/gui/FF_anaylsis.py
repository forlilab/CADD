...
class FilterManager(rb.RaccoonDefaultWidget, Pmw.Group, DebugTools.DebugObj):
    ...
    def makeInterface(self):
        ...
        #
        f = tk.Frame(i)
        self.applyButton = tk.Button(f, text='Apply filters', image = self._ICON_filter, height=30,
	...
	# the following needs to be packed here otherwise it will not expand the button
        self.interactFiltManager.pack(side='top', anchor='w', padx=5, expand=1, fill='both')
...
###
    ...
    def applyLigStyle(self, event=None):
        ...
        viewer.mv.colorByAtomType(main, log=0)
